// -------------------------------------------------------------
// 
// File Name: hdlsrc\NRPolarDecodeHDL\CRCGenerator_block.v
...
module CRCGenerator_block
  ...
  CRCGenControl_block u_Controlsignal_inst (.clk(clk),
                                            .reset(reset),
                                            .enb(enb),
  ...
  // 
  // Select CRC output bits
  CRCGenCompute_block u_ComputeCRC_inst (.clk(clk),
                                         .reset(reset),
                                         .enb(enb),
                                         .datainReg(datainReg),
                                         .validIn(validIn),  // ufix1
