// -------------------------------------------------------------
// 
// File Name: hdlsrc\NRPolarDecodeHDL\CRCGenCompute_block.v
// Created: 2022-01-15 05:13:25
// 
...
// -------------------------------------------------------------
// 
// Module: CRCGenCompute_block
// Source Path: NRPolarDecodeHDL/HDL Algorithm/NR Polar Decoder/CRC Decoder/CRCGenerator/CRCGenCompute
// Hierarchy Level: 4
// 
...
module CRCGenCompute_block
  ...
  wire tcsSel;  // ufix1
  wire csSel;  // ufix1
  wire checksumRst;  // ufix1
  wire rpadZero;  // ufix1
  wire dataSel;  // ufix1
  wire [0:10] padingzeros;  // ufix1 [11]
  wire [0:9] inputzeros;  // ufix1 [10]
  wire [0:10] datamux;  // ufix1 [11]
  wire [0:10] datacpt;  // ufix1 [11]
  ...
  wire [0:10] finalXorValue;  // ufix1 [11]
  ...
  wire [0:10] newChecksum;  // ufix1 [11]
  ...
  wire [0:10] xoredChecksum;  // ufix1 [11]
  reg  [0:10] checksumReg;  // ufix1 [11]
  ...
  wire [0:10] tchecksum;  // ufix1 [11]
  wire [0:10] finalChecksum;  // ufix1 [11]
  reg  [0:10] crcChecksum;  // ufix1 [11]


  assign xoredSel = counter == 4'b1010;
  ...
  assign checksumRst = xoredSel | regClr;
  ...
  assign refelctCheckSum_10 = newChecksum_0 ^ finalXorValue_10;



  assign newChecksum_1 = newChecksum[1];

  assign refelctCheckSum_9 = newChecksum_1 ^ finalXorValue_9;



  assign newChecksum_2 = newChecksum[2];

  assign refelctCheckSum_8 = newChecksum_2 ^ finalXorValue_8;



  assign newChecksum_3 = newChecksum[3];

  assign refelctCheckSum_7 = newChecksum_3 ^ finalXorValue_7;



  assign newChecksum_4 = newChecksum[4];

  assign refelctCheckSum_6 = newChecksum_4 ^ finalXorValue_6;



  assign newChecksum_5 = newChecksum[5];

  assign refelctCheckSum_5 = newChecksum_5 ^ finalXorValue_5;



  assign newChecksum_6 = newChecksum[6];

  assign refelctCheckSum_4 = newChecksum_6 ^ finalXorValue_4;



  assign newChecksum_7 = newChecksum[7];

  assign refelctCheckSum_3 = newChecksum_7 ^ finalXorValue_3;



  assign newChecksum_8 = newChecksum[8];

  assign refelctCheckSum_2 = newChecksum_8 ^ finalXorValue_2;



  assign newChecksum_9 = newChecksum[9];

  assign refelctCheckSum_1 = newChecksum_9 ^ finalXorValue_1;
  ...
  assign refelctCheckSum_0 = newChecksum_10 ^ finalXorValue_0;
  ...
  assign tcs_entry10 = datacpt_0 ^ (checksumReg_10 ^ checksumReg_9);
  ...
  assign tcs_entry9 = datacpt_1 ^ (checksumReg_10 ^ checksumReg_8);
  ...
  assign tcs_entry8 = checksumReg_7 ^ datacpt_2;
  ...
  assign tcs_entry7 = checksumReg_6 ^ datacpt_3;
  ...
  assign tcs_entry6 = checksumReg_5 ^ datacpt_4;
  ...
  assign tcs_entry5 = datacpt_5 ^ (checksumReg_10 ^ checksumReg_4);
  ...
  assign tcs_entry4 = checksumReg_3 ^ datacpt_6;
  ...
  assign tcs_entry3 = checksumReg_2 ^ datacpt_7;
  ...
  assign tcs_entry2 = checksumReg_1 ^ datacpt_8;
  ...
  assign tcs_entry1 = checksumReg_0 ^ datacpt_9;
  ...
  assign tcs_entry0 = checksumReg_10 ^ datacpt_10;
