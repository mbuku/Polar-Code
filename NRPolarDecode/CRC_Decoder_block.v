// -------------------------------------------------------------
// 
// File Name: hdlsrc\NRPolarDecodeHDL\CRC_Decoder_block.v
...
module CRC_Decoder_block
  ...
  // HDL CRC Generator
  CRCGenerator_block u_HDLCRCGen_inst (.clk(clk),
                                       .reset(reset),
                                       .enb(enb),
  ...
  endInNet_block u_endInEntity (.clk(clk),
                                .reset(reset),
                                .enb(enb),
                                .endin(endin_ff_1),
                                .out(endin_ffdel)
  ...
  CRCCompNet_block u_ErrPortEntity (.clk(clk),
                                    .reset(reset),
                                    .enb(enb),
                                    .in1(dataoutgen),
                                    .in2(crc_to_mask),
