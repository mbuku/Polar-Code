// -------------------------------------------------------------
// 
// File Name: hdlsrc\NRPolarDecodeHDL\ramNet_block.v
...
module ramNet_block
  ...
  input   wr_en;
  input   rd_addr;  // ufix1
  output  [1:0] dout;  // ufix2


  wire addrComp_0;
  wire wr_0;
  reg [1:0] ramData_0;  // ufix2
  wire addrComp_1;
  wire wr_1;
  reg [1:0] ramData_1;  // ufix2
  wire [1:0] ramDataSel;  // ufix2
  reg [1:0] dout_1;  // ufix2
